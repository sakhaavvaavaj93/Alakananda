...
from Alakananda.__main__ import STATS, TOKEN, USER_INFO
from Alakananda.modules.sql import SESSION
import Alakananda.modules.sql.userinfo_sql as sql
from Alakananda.modules.disable import DisableAbleCommandHandler
from Alakananda.modules.sql.global_bans_sql import is_user_gbanned
from Alakananda.modules.sql.afk_sql import is_afk, set_afk
from Alakananda.modules.sql.users_sql import get_user_num_chats
from Alakananda.modules.helper_funcs.chat_status import sudo_plus
from Alakananda.modules.helper_funcs.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
         ...
         text += "\n\nOwner Of A Bot. Queen Of @Alakananda. Bot Name Inspired From 'JoJo'."
         disaster_level_present = True
