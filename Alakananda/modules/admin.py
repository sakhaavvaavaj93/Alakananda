...
from Alakananda import DRAGONS, dispatcher
...
from Alakananda.modules.helper_funcs.admin_rights import user_can_changeinfo, user_can_promote
...
def lowpromote(update: Update, context: CallbackContext) -> str:
    ...
    try:
        bot.promoteChatMember(
            ...
            can_Add_New_Admin=bot_member.can_add_new_admins,
            can_change_group_info=bot_member.can_change_group_info
        )
    except BadRequest as err:
        if err.message == "User_not_mutual_contact":
            message.reply_text("I can't promote someone who isn't in the group.")
