...
import Alakananda.modules.sql.global_bans_sql as gban_sql
import Alakananda.modules.sql.users_sql as user_sql
from Alakananda import DEV_USERS, OWNER_ID, dispatcher
