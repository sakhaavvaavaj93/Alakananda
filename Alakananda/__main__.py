...
buttons = [
    [
        InlineKeyboardButton(
            text="➗ Add Shu Kurenai To Your Group ➗", url="t.me/Alakananda?startgroup=new"),
    ],
    [
        InlineKeyboardButton(
              text="Help",
...
def shukurenai_about_callback(update, context):
    ...
    if query.data == "shukurenai_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/shukurenai007/Alakananda"),
        ...
        query.message.edit_text(
            ...
            "\nHere Developers Making And Give Inspiration For Made The Alakananda",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
