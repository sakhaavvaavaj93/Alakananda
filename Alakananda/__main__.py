...
HELP_IMG = "https://telegra.ph/file/59453cf05daa750f973eb.png"
GROUP_IMG = "https://telegra.ph/file/30dbcb7870a79eac0d54d.png"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="✧ Support ", url=f"https://telegram.dog/stenzle_appeal_chat"),
                  InlineKeyboardButton(text="✧ Updates ", url=f"t.me/stenzle_appeal_chat/2"),
                  ]
                ]
            ),
        )
...
def shukurenai_about_callback(update, context):
    ...
    if query.data == "shukurenai_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/jayasankarj93/Alonemanbot"),
        ...
        query.message.edit_text(
            text="*๏ @Stenzle_MariaGbot support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on @stenzle_appeal_chat or on [@FULL_CRUAL_MIND].",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
        ...
        query.message.edit_text(
            ...
            "\nHere Developers Making And Give Inspiration For Made The @Stenzle_MariaGbot",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="സഖാവ് വാവ", url="https://github.com/sakhaavavaavaj93"),
                    InlineKeyboardButton(text="jayasankarj93", url="https://github.com/jayasankarj93"),
                    InlineKeyboardButton(text="Nandha", url="https://github.com/momskidvaava"), 
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="shukurenai_"),
                 ]
