...
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
x i can sing audio and video in your chat on No lagging and fully stable
────────────────────────
...
HELP_IMG = "https://telegra.ph/file/bf2a90eb09de80957ef08.jpg"
GROUP_IMG = "https://telegra.ph/file/84cb3653b4acfd146eec2.jpg"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text="✧ Support ", url=f"https://telegram.dog/kk_kovilakam"),
...
def shukurenai_about_callback(update, context):
    ...
    if query.data == "shukurenai_":
        query.message.edit_text(
            ...
            "\n* I can sing on your chat lag free."
            ...
            "\n\n Click on button bellow to get basic help for Alakananda.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/sakhaavvaavaj93/Alonemanbot"),
        ...
        query.message.edit_text(
            ...
            "\nCongragulation, @Stenzle_MariaGbot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Github", url="https://github.com/sakhaavvaavaj93"),
                    InlineKeyboardButton(text="Ash_pro", url="https://github.com/dreambotsProduction"),
                    InlineKeyboardButton(text="Jayasankarj93", url="https://github.com/Jayasankarj93"), 
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="shukurenai_"),
                 ]
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            ...
            "\n • `/play` <query /reply audio> - Playing music or video via YouTube."
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[𝐈 𝐀𝐦 𝐎𝐧𝐥𝐢𝐧𝐞](https://telegra.ph/file/bf2a90eb09de80957ef08.jpg)", parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                  [                  
                       InlineKeyboardButton(
                       ...
                       InlineKeyboardButton(
                             text="Updates🛰️",
                             url="https://t.me/stenzle_appeal_chat")
                     ] 
                ]
            ),
        )
