...
from Alakananda import pbot as app 
from Alakananda import arq
from Alakananda.services.keyboard import Ikb
from Alakananda.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Alakananda.services.tasks import _get_tasks_text, all_tasks, rm_task
from Alakananda.services.types import InlineQueryResultCachedDocument
from Alakananda.modules.info import get_chat_info, get_user_info
from Alakananda.modules.music import download_youtube_audio
from Alakananda.utils.functions import test_speedtest
from Alakananda.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Alakananda"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Alakananda 🔥](http://telegra.ph/file/0adf9e97735ba8a420973.jpg):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
